...
public class UserController {
	...
	@Autowired
	public UserController(UserService userService, JdbcUserRepository jdbcUserRepository) {
	...
	public void login(UserForm form, HttpServletResponse response, Exception e) throws Exception {
		...
		// 아이디 비밀번호 불일치
			...
			//로그인 성공
			Long loginId = jdbcUserRepository.findByEmail(user.getEmail()).get().getId();
